...
/**
 * "Next workout" card on Today. Routine name on top, exercise preview
 * line below, "Start" affordance on the right. The Start affordance is
 * a TEXT BUTTON, not filled — daily/repeat actions never get filled
 * amber per the design system rule.
 */
