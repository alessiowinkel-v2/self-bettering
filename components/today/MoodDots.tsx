...
/**
 * Five-dot mood row used in the Yesterday peek and (later) the Journal
 * editor. This is a 1-to-5 RATING BAR, not a single-selected indicator —
 * dots up to and including the chosen value are filled, the rest are
 * hollow rings. A mood of 3 renders as filled-filled-filled-empty-empty.
 */
