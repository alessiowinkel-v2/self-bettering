...
/**
 * Every set logged for a given workout, in (exercise_name, set_number)
 * order. Used by resume-in-progress to reconstruct the active workout's
 * exercises[] from disk after an abandon.
 */
